    ...
    <Layout>
      ...
      <section className={`${ChoiceStyles.how} ${Styles.how}`}>
        ...
        <div className={`${GlobalStyles.inner} ${ChoiceStyles.howInner}`}>
          <div className={`${ChoiceStyles.howContent} ${Styles.howContent}`}>
            ...
            >
              <li>
                When livestock digests their food they burp up methane gas.
                Manure and rice paddies are also big contributors to methane in
                the atmosphere.
              </li>
              <li>
              ...
              <li>
                We waste ⅓ of all food. That means we’ve unnecessarily used
                vital energy to produce it, releasing greenhouse gases in the
                process - and when it’s dumped it rots becoming methane gas.
              </li>
              <li>
      ...
      <section className={`${ChoiceStyles.stops} ${Styles.stops}`}>
        <div className={`${GlobalStyles.inner} ${ChoiceStyles.stopsInner}`}>
          ...
          <div
            className={`${ChoiceStyles.stopsContent} ${Styles.stopsContent}`}
          >
            <div
            ...
            >
              ...
              >
                ...
                <li>
                  The way we eat today is perceived as normal, with changing
                  comes social pressure to return to 'normal' eating practices.
                </li>
                <li>
      ...
      <section className={`${ChoiceStyles.actions} ${Styles.actions}`}>
        ...
        <div className={`${GlobalStyles.inner} ${ChoiceStyles.actionsInner}`}>
          <div
            className={`${ChoiceStyles.actionsContent} ${
              Styles.actionsContent
            }`}
          >
            <h1
              className={`${ChoiceStyles.actionsTitle} ${Styles.actionsTitle}`}
            >
              What you can do now
            </h1>
          </div>
          <div className={`${ChoiceStyles.action} ${Styles.action}`}>
            <div
              className={`${ChoiceStyles.actionContent} ${
                Styles.actionContent
              }`}
            >
              <h2
                className={`${ChoiceStyles.actionTitle} ${Styles.actionTitle}`}
              >
                The easiest thing to do is to consume less food with a high
                carbon footprint
              </h2>
              <p className={`${ChoiceStyles.paragraph} ${Styles.paragraph}`}>
                ...
                <b>If you’re really committed, go vegan</b>. Try to only buy
                items with <b>sustainable, or no packaging</b>, and{" "}
                <b>buy local</b> so your food isn’t travelling around the world.
              </p>
              <h3
            ...
            <div
              className={`${ChoiceStyles.actionAside} ${Styles.actionAside}`}
            >
              <div
          ...
          >
            ...
            >
              ...
              <p className={`${ChoiceStyles.paragraph} ${Styles.paragraph}`}>
                Roughly 1/3 of food each year goes to waste. If we all became
                more efficient with our food, less would need to be produced and
                less would be left to rot - reducing greenhouse emissions.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className={`${GlobalStyles.inner} ${ChoiceStyles.tldrInner}`}>
          ...
          <div className={`${ChoiceStyles.tldrContent} ${Styles.tldrContent}`}>
            ...
            >
              ...
              <p
                className={`${ChoiceStyles.tldrSubtitle} ${
                  Styles.tldrSubtitle
                }`}
              >
