      ...
      <div className={`${GlobalStyles.inner} ${ChoiceStyles.howInner}`}>
        <div className={`${ChoiceStyles.howContent} ${Styles.howContent}`}>
          ...
          >
            <li>
              <b>
                15% of of all global green-house gas emissions come directly
                from transportation
              </b>
              , for our commute to work, flying for vacation, taking a train for
              a business meeting, etc.
            </li>
            <li>
              On top of that 15% is the assembly process, which requires energy,
              generating huge carbon emissions for all modes of transport before
              they're even used! When a fossil-fuel burning vehicle hits the
              road it releases tonnes of carbon in the process. There are over 1
              billion of these vehicles on the road today.
            </li>
            <li>
              <b>2% of the worlds emissions come from air travel</b>, but only
              10% of people in the world fly. 2% is the same amount as
              processing the entire worlds sewage, and 100% of the world are
              involved in that.
            </li>
            <li>
              Fossil fuels first need to be extracted, refined, and transported
              for use, all of which uses a lot of energy. There are leakages and
              spillages at every step of this process.
            </li>
            <li>
              Electric cars don’t emit any carbon once on the road, however they
              do require energy which has to come from somewhere. An electric
              car running on electricity generated by coal can create more CO2
              than a petrol car.
            </li>
            <li>
              Contrary to popular belief, modern petrol cars produce more
              emissions than older models. The engines are becoming more
              efficient with new technology, but cars are getting bigger and
              heavier, with SUV's and luxury vehicles becoming more popular,
              even in 2020.
            </li>
          </ol>
        </div>
      ...
      <div className={`${GlobalStyles.inner} ${ChoiceStyles.stopsInner}`}>
        ...
        <div className={`${ChoiceStyles.stopsContent} ${Styles.stopsContent}`}>
          ...
          >
            ...
            >
              <li>
                Many people have picked the location of our homes and the jobs
                we work at, based on having access to a car, so there may not be
                public transport.
              </li>
              <li>
                Many people have chosen the city or country we live in based on
                the assumption we can fly home to visit family easily.
              </li>
              <li>
                Unlike train travel, flying is heavily subsidized with our tax
                money, so we pick the cheaper mode of transportation.
              </li>
              <li>
      ...
      <div className={`${GlobalStyles.inner} ${ChoiceStyles.actionsInner}`}>
        ...
        <div className={`${ChoiceStyles.action} ${Styles.action}`}>
          ...
          >
            ...
            <p className={`${ChoiceStyles.paragraph} ${Styles.paragraph}`}>
              ...
              though it's important to ensure your electricity supply is as
              close to 100% renewable as possible.
            </p>

            <p className={`${ChoiceStyles.paragraph} ${Styles.paragraph}`}>
              Owning an electric car is not as expensive as you might think, as
              many countries offer tax rebates, free road tax, and over the long
              term there are savings to be made on recharging and maintenance.
              <b>
                {" "}
              ...
              money over time. Even better, if you're a couple/family with two
              petrol cars, you could sell the two petrol cars, buy one electric
              car, one electric bicycle for commuting, and still have money left
              over for a train vacation to explore somewhere amazing closer to
              home.
            </p>
            <p>
              Another approach is getting vehicles converted. This reduces the
              amount of manufacturing emissions associated with your vehicle
              switch.
            </p>
        ...
        >
          ...
          >
            ...
            <p className={`${ChoiceStyles.paragraph} ${Styles.paragraph}`}>
              Airline companies often talk about a sustainable future, but there
              is no viable technology to decarbonize flying any time in the next
              20 years. Biofuel is often mentioned, but that requires mass
              deforestation to plant monoculture crops. The growing, processing,
              and transportation is still horrendous. Electric planes are being
              used for 30 minute hops in Norway, but they're a long way from
              replacing long haul flights.
            </p>
            <p className={`${ChoiceStyles.paragraph} ${Styles.paragraph}`}>
              Until someone figures out how to decarbonise airplanes we are
              going to have to make some changes to our lifestyles. Try and{" "}
              <b>
            ...
            <p className={`${ChoiceStyles.paragraph} ${Styles.paragraph}`}>
              ...
              emissions, but this is created by 10% of the population.{" "}
              <b>
                The recommended sustainable annual footprint for a single person
                is 2.3 tonnes of CO2, and flying a long-haul return trip could
                be 50-90% of that annual budget used in one go
              </b>
              . For the small number of flyers, stopping flying is the biggest
              impact they could have on their footprint.
            </p>
          </div>
        </div>
      </div>
