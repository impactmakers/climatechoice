...
const ChangeYourJobPage = () => (
  <Layout>
    <SEO
      ...
      description=" The majority of all pollution produced can be traced back to some form of business operation or its production."
      ...
      <div className={`${GlobalStyles.inner} ${ChoiceStyles.inner}`}>
        ...
        >
          ...
          <p className={`${ChoiceStyles.bannerDesc} ${Styles.bannerDesc}`}>
            ...
            some form of business operation or its production.
          </p>
        ...
        <div className={`${ChoiceStyles.howContent} ${Styles.howContent}`}>
          ...
          >
            ...
            <li>
              ...
              almost 40 percent of our garbage.
            </li>
            <li>
              <b>Lack of recycling policies</b>. This applies to all business
              environments, from offices to industrial factories. The wastage
              might be directly related to the production of the business or
              even organic waste such as the employee's lunch scraps.
            </li>
          </ol>
        </div>
      </div>
    ...
    <section className={`${ChoiceStyles.actions} ${Styles.actions}`}>
      ...
      <div className={`${GlobalStyles.inner} ${ChoiceStyles.actionsInner}`}>
        ...
        <div className={`${ChoiceStyles.action} ${Styles.action}`}>
          ...
          <ol
            className={`${ChoiceStyles.choiceList} ${ChoiceStyles.nowList} ${
              Styles.nowList
            }`}
          >
            <li>
              Reduce waste by choosing products that have minimal packaging and
              can be used productively and then recycled. Re-use plastic bags
              and all types of containers if possible.
            </li>
            <li>
            ...
            <li>
              For paper specifically: Make double-sided copies when printing and
              photocopying, wherever possible. Use the blank side of used paper
              for notepaper before recycling. Re-use envelopes for internal
              mail.Try to integrate electronic procedures to reduce paper work.
            </li>
            <li>
            ...
            <li>
              ...
              waste to make it less harmful or reduce the volume of the harmful
              component. Dispose of the waste safely.
            </li>
            <li>
